                ...
                <div class="col-9 mx-auto">
                    <form method="post" id="updateTaskForm">
                        ...
                        <div class="form-floating my-3">
                            <input type="text" class="form-control" id="name" name="name" value="<?php echo $targetdata['name']?? ''; ?>" readonly>
                            <label for="name">Name</label>
                        </div>


                        <div class="form-floating my-3">
                            <input type="text" class="form-control" id="title" name="title" value="<?php echo $targetdata['title']?? ''; ?>" readonly>
                            <label for="title">Task Title</label>
                        </div>


                        <div class="form-floating my-3">
                            <input type="date" class="form-control" id="deadline" name="deadline" value="<?php echo $targetdata['deadline']?? ''; ?>" readonly>
